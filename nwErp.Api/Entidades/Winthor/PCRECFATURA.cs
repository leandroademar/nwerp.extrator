...
[Serializable]
public class PCRECFATURA : GerenteDePropriedades, IEntidade
{
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 1, Precisao = 0)]
    public string Banco
    {
        get
        {
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 6, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 2, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 8, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 40, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 55, Precisao = 0)]
    ...
    public string Consolidado
    {
        get
        {
            PropriedadeAcessada("Consolidado");
            return _consolidado;
        }
        set
        {
            PropriedadeModificada("Consolidado", value);
            _consolidado = value;
        }
    }

    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Data, Tamanho = 7, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 10, Precisao = 2)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 20, Precisao = 0)]
    public string Nsu
    {
        get
        {
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 4, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 10, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 10, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 30, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 12, Precisao = 2)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCRECFATURA", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 5, Precisao = 0)]
    ...
    public void CarregarPorDataReader(IDataReader leitor)
    {
        ...
        _consolidado = AlterarTipo<string>(leitor["Consolidado"]);
