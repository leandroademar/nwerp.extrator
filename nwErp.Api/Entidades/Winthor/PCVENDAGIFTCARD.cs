...
[Serializable]
public class PCVENDAGIFTCARD : GerenteDePropriedades, IEntidade
{
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 255, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 6, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 8, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = true, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Data, Tamanho = 7, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Data, Tamanho = 7, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 1, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 4, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = true, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 8, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = true, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 25, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 10, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = true, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Texto, Tamanho = 30, Precisao = 0)]
    ...
    [InfoCampoEntidade(ChavePrimaria = false, Tabela = "PCVENDAGIFTCARD", Tipo = TipoDoCampoNoBancoDeDados.Decimal, Tamanho = 16, Precisao = 3)]
